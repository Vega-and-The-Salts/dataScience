...
var apiKey = "pk.eyJ1IjoiZGlzZ3V5IiwiYSI6ImNrY3pkdHpqYzBnenIzMWw1MHBlaTF5MnQifQ.M9N65OjFCsY6e2HIaiC2zw";
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson", function(data) {
  ...
  L.geoJson(data, {
    ...
    onEachFeature: function(feature, layer) {
      ...
      //TODO: POPULATE THE JSON OF PROPERTIES TO A TABLE, INFORMATION, LOCATION,DATE,COORDINATES
      var index = filteredData.length == 0 ? 0 : filteredData.length++;
      filteredData[index] = [feature.properties.mag,feature.properties.place,new Date(feature.properties.time * 1000).toUTCString(),feature.geometry.coordinates[0] + " , " + feature.geometry.coordinates[1] + " , " + feature.geometry.coordinates[2]];
  ...
  for(var i =0; i< filteredData.length; i++){
    ...
    for(var j =0; j< filteredData[i].length; j++){
      content += '<td>' + filteredData[i][j] + '</td>';
    }
    content += '</tr>';
  }
  var table = $("#tbEarthQuickInfo");
